...
plt.pie(counts, labels = ['A', 'B'], autopct = '%d%%')
plt.axis('equal')
plt.plot
...
X_1 = [[250, 2254], [325, 2175]]
_,pval_1,_,_ = chi2_contingency(X_1)
print pval_1
...
X_2 = [[200, 50], [250, 75]]
_,pval_2,_,_ = chi2_contingency(X_2)
print pval_2
...
X_3 = [[200, 2304], [250, 2250]]
_,pval_3,_,_ = chi2_contingency(X_3)
print pval_3
...
plt.bar(x_vals, app_pivot['Percent with Application'])
ax = plt.subplot()
...
plt.savefig('Percent_Vis_Apply.png')
...
labels = ['Fitness Test', 'No Fitness Test']
x_vals = range(len(labels))
plt.bar(x_vals, member_pivot['Percent Purchase'])
ax = plt.subplot()
...
labels = ['Fitness Test', 'No Fitness Test']
x_vals = range(len(labels))
plt.bar(x_vals, final_member_pivot['Percent Purchase'])
ax = plt.subplot()
...
plt.savefig('Percent_Vis_Purch.png')
